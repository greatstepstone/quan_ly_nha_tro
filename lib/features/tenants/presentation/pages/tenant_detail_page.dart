...
class TenantDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final tenant = MockData.tenants.firstWhere((t) => t.id == tenantId, orElse: () => MockData.tenants.first);
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(tenant.startDate, style: GoogleFonts.manrope(fontSize: 14, fontWeight: FontWeight.w700)),
                          ],
                        ),
                      ),
                      Expanded(
