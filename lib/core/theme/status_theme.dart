...
extension RoomStatusUI on RoomStatus {
  Color get color {
    switch (this) {
      ...
      case RoomStatus.deposited:   return const Color(0xFFf59e0b);
  ...
  IconData get icon {
    switch (this) {
      ...
      case RoomStatus.deposited:   return Icons.bookmark_outline;
...
extension InvoiceStatusUI on InvoiceStatus {
  Color get color {
    switch (this) {
      ...
      case InvoiceStatus.waitingPayment: return const Color(0xFFf59e0b);
  ...
  IconData get icon {
    switch (this) {
      ...
      case InvoiceStatus.sent:           return Icons.send_rounded;
      case InvoiceStatus.waitingPayment: return Icons.hourglass_top_rounded;
