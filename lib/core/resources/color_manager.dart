...
class AppColors {
  ...
  static Color get primaryLight =>
      isDark ? const Color(0xFF1e3a5f) : const Color(0xFFd1eefc);
  static Color get primaryDark => const Color(0xFF0d7ab5);

  // Surface hierarchy
  static Color get surface =>
      isDark ? const Color(0xFF121212) : const Color(0xFFf6f7f8);
  ...
  static Color get chartLightGray =>
  ...
  static Color get addCardSubtleIconCircle =>
      isDark
          ? const Color(0xFF244a76)
          : primaryLight; // primaryLight is 0xFFd1eefc in light
  ...
  static Color get addCardLightButton => isDark ? primary : primaryDark;
}
